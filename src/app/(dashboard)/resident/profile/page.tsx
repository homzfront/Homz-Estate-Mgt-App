...
import ChangePassword from './(changePassword)/changePassword' // import your change password component
    ...
    <div className='p-8 mb-[150px]'>
      ...
      <div className='mt-4 flex gap-4'>
        ...
        <button
          ...
          className={`px-4 py-2 rounded-md ${activeTab === 'password' ? 'bg-BlueHomz text-white' : 'bg-gray-200 text-gray-600'}`}
        >
          Change Password
        </button>
      </div>
