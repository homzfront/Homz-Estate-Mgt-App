        ...
        <div className='mt-4 md:mt-8'>
          ...
          <div className='bg-whiteblue p-4 w-full rounded-[12px] flex flex-col justify-between border border-BlueHomz'>
            <div className='flex justify-between items-center'>
              ...
              <span onClick={() => router.push(`/resident/estate-info/${selectedEstate?.estateId}`)} className='cursor-pointer text-xs md:text-[13px] font-normal text-BlueHomz hidden md:flex items-center gap-1 hover:opacity-70 active:scale-95 transition-all duration-150 select-none'>More Info <ArrowRight className='#006AFF' /></span>
            </div>
