...
function PopUp({ setOpenDetails, fromDefault = true, setOpenRevoke }: PopUpProps) {
    ...
    return (
        <div>
            <div
                className={`drop-down absolute top-11 z-100 w-[150px] md:w-[180px] text-GrayHomz font-[500] text-[13px] right-[67px] border py-2 rounded-md ${fromDefault ? "bg-[#F6F6F6]" : "bg-white"} bg-white flex flex-col items-center justify-around `}
            >
                {/* More Details */}
                <div
