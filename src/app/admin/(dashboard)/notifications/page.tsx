...
type NotificationFilterTab = 'all' | 'BILLINGS_PAYMENTS' | 'ACCESS_CONTROL' | 'WALLET_TRANSACTIONS' | 'SYSTEM_SECURITY' | 'MAINTENANCE' | 'GENERAL';
type NotificationsSection = 'inbox' | 'broadcast';
...
const SECTION_TABS: { key: NotificationsSection; label: string }[] = [
...
export default function AdminNotificationsPage() {
    ...
    const [sectionTab, setSectionTab] = useState<NotificationsSection>('inbox');
    ...
    const fetchNotifications = useCallback(async (p = 1) => {
        ...
        try {
            ...
            if (filterTab !== 'all') params.type = filterTab;
    ...
    return (
        <div className='p-6 md:p-8 w-full max-w-[860px]'>
            ...
            {/* Section tabs */}
            <div className='mb-6 flex flex-col gap-3 rounded-[14px] border border-[#E8E8E8] bg-white p-3 shadow-sm sm:flex-row sm:items-center sm:justify-between'>
