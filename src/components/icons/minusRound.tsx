...
const MinusRound = ({ color = "#4E4E4E", colorTwo = "#292D32" }) => {
    return (
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M6.11328 9.89052L9.88661 6.11719" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M9.88661 9.89052L6.11328 6.11719" stroke={colorTwo} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    )
}
